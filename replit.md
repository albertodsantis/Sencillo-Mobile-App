...
- **Data Persistence**: AsyncStorage (`lib/data/storage.ts`) for local data storage of transactions, rates, P&L structure, and budgets. Each data type has its own storage key prefixed with `@sencillo/`
